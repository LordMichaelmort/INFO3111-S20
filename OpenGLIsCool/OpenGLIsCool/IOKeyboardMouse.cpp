// Where the immediate keyboard and mouse control will go
...
//extern cCameraManager* g_pCameraManager;
...
{
	::g_pFlyCamera->Roll_CW_CCW(::g_pJoysticks->getJoystickAxis(0, 1, true));


	return;
}

// Resize the window and the FBO
